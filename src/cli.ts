...
async function main() {
  ...
  program.command("decompress [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
  ...
  program.command("ccr-stats [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
  ...
  program.command("ccr-clean [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      {
  ...
  program.command("align-cache [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      const stdin = await readStdin();
  ...
  program.command("cache-stats [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      {
  ...
  program.command("learn-analyze [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
  ...
  program.command("learn-report [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      console.log(JSON.stringify(getLearnReport(), null, 2));
    });
  program.command("learn-log [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
  ...
  program.command("learn-resolve [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      const id = args[0];
  ...
  program.command("learn-match [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      {
  ...
  program.command("memory-store [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
  ...
  program.command("memory-query [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
  ...
  program.command("memory-stats [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      console.log(JSON.stringify(getMemoryStats(), null, 2));
    });
  program.command("memory-export [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
  ...
  program.command("memory-sync [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
  ...
  program.command("memory-platforms [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      {
  ...
  program.command("dream [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      console.log(JSON.stringify(runDreamingCycle(), null, 2));
    });
  program.command("curate [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      {
  ...
  program.command("dead-code [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      {
  ...
  program.command("semantic-search [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      try {
  ...
  program.command("embedding-stats [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      {
  ...
  program.command("changelog [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
  ...
  program.command("vuln-scan [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
  ...
  program.command("onboarding-docs [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      {
  ...
  program.command("team-metrics [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      console.log(JSON.stringify(getTeamMetrics(), null, 2));
    });
  program.command("pr-check [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
  ...
  program.command("benchmark [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      {
  ...
  program.command("api-contract [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      {
  ...
  program.command("config-validator [args...]")
    .alias("validate")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
  ...
  program.command("license-check [args...]")
    .alias("licenses")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
  ...
  program.command("complexity [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      {
  ...
  program.command("log-analyze [args...]")
    .alias("logs")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
  ...
  program.command("db-schema [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      {
  ...
  program.command("experience [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      {
  ...
  program.command("consistency [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      {
  ...
  program.command("knowledge [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      {
  ...
  program.command("preflight [args...]")
    .allowUnknownOption(true)
    .action(async (commandArgs, options, cmdObj) => {
      const args = cmdObj.args || [];
      {
